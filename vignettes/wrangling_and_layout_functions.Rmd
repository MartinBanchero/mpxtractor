...
If there are NA's present in "Measurement" column the row containing this NA's is
removed.
...
data_multiscan <- mpxtractor::read_multiscango_data(file = file_path, time_interval = "2.5 min" )
head(data_multiscan)
```
