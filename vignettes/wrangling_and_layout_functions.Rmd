...
to  avoid different issues realated to file formats, like .csv, .xlsx or versions. This is simplified by using only .txt files.
...
Receive one raw file and generate a tibble dataframe and takes a time point which is given as argument.
...
data_multiscan <- mpxtractor::read_multiscango_data(
  file = file_path,
  time_interval = "2.5 min", input_type = "table"
)
head(data_multiscan)
```
