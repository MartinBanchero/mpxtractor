...
data in R, all this wrangling functions receive a file with .txt extension. This to avoid different issues related to file formats, like .csv, .xlsx, or different versions. This is simplified by using only .txt files.
...
In this format, the raw data is more similar to a data frame. This file contains more information than the "table" format, for example, contain the time, this is the reason that the argument time_interval is not needed.
