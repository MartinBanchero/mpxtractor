...
>>>>>>> b7a5d036382b1016d871888d806c9ddaecce366a
...
ggplot2::ggsave(filename = "test.png", plot = microplateplot, width = 70, height = 50, units = "cm")
```
...
knitr::include_graphics('./gr_spectramax_test.png')
```
