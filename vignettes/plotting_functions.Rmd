...
```{r,fig.width = 7, fig.height = 6 ,out.width = "100%", out.height = "100%", fig.cap="**Figure 1:** Representation over a microplate frame of two different conditions, condition and strain. Note that strain contain less than 6 factors."}
