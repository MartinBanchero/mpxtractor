...
library(mpxtractor)
library(dplyr)
knitr::opts_chunk$set(fig.width = 7.2, fig.height = 5 ,collapse = TRUE, comment = "#>")
```
...
htmlTable::htmlTable(as.matrix(table1), col.rgroup = cols, caption = "**Table 1:** Shows the timestep that breaks the time series")
