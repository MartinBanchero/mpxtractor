...
```{r, fig.width = 7, fig.height = 6 ,out.width = "100%", out.height = "100%",fig.show='hold', fig.cap="**Figure 1:** Showing the layout position for Basic and presugar "}
...
```{r , fig.width = 7, fig.height = 8 ,out.width = "100%", out.height = "100%"}
...
pl <- mpxtractor::plot_layout_dataframe(
  df, 
  var_shape = "Basic", 
...
pl
#ggplot2::ggsave(filename = "layout_test.png", plot = pl, width = 70, height = 50, units = "cm")
```
...
```{r, fig.width = 20, fig.height = 15 ,out.width = "100%", out.height = "100%"}
mpxtractor::plot_gr_microplate(
  df_data = df_combine, 
