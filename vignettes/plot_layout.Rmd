...
```{r}
 go_data <- mpxtractor::read_multiple_files(reader_type = "multiscango", filesname = c("../inst/extdata/multiscanGO_1streading.txt", "../inst/extdata/multiscanGO_2ndreadings.txt"))
...
```{r}
plot_plate <- mpxtractor::plot_lyout_file(file = "../inst/extdata/spectraMax_layout_plate1.csv", var_shape = "basic", var_colour = "condition", name_plate_layout = "Plate experiment")
plot_plate
```
